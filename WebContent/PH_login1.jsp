...
try
{
	String a = request.getParameter("phID");
	...
	String sss = "select * from policyholder where name='"+a+"' && password='"+b+"'";
	...
	if(rs.next()){
		try{
			...
			String sss1 = "select * from policyholder where agentID='"+a+"' && password='"+b+"'";
		...
		response.sendRedirect("policyholder.jsp");
	}
	else{
